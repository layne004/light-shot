...
struct qt_meta_stringdata_CLASSScreenshotManagerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSScreenshotManagerENDCLASS = QtMocHelpers::stringData(
    "ScreenshotManager",
    "mouseClicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSScreenshotManagerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ScreenshotManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSScreenshotManagerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSScreenshotManagerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSScreenshotManagerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void ScreenshotManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (ScreenshotManager::*)();
            if (_t _q_method = &ScreenshotManager::mouseClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ScreenshotManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSScreenshotManagerENDCLASS.stringdata0))
...
// SIGNAL 0
void ScreenshotManager::mouseClicked()
{
